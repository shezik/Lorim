...
class GEMProxy : public GEM_u8g2 {
    public:
        ...
        // I changed access control of GEM_u8g2 private members to protected, and declared drawMenu as virtual, for I had no other choices;
        // this is the slightest change I could possibly think of.
